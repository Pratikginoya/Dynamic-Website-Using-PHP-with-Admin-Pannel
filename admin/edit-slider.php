...
$edit_sql_select = "select * from `slider` where `ID`='$edit_id'";
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Title of Slider" name="title" maxlength="10" required value="<?php echo @$row['Title']; ?>">
                  </div>
                  <div class="form-group">
